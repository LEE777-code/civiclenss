    ...
    <div className="mobile-container min-h-screen bg-background px-6 py-12 relative">
      ...
      <div className="mt-8">
        ...
        <SignInButton mode="modal">
          <button type="button" className="w-full h-12 bg-white border border-input rounded-xl flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors">
