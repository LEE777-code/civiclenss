...
const Login = () => {
  ...
  return (
    <div className="mobile-container min-h-screen bg-background px-6 py-12">
      <div className="flex flex-col items-center mb-8">
        <div className="w-16 h-16 bg-primary rounded-2xl flex items-center justify-center mb-4">
          <Shield size={32} className="text-primary-foreground" />
        </div>
        <h1 className="text-2xl font-bold text-primary">Civic Guardian</h1>
      ...
      <div className="mt-8">
        ...
        <div className="flex justify-center gap-4">
          <button className="w-14 h-14 bg-muted rounded-xl flex items-center justify-center">
